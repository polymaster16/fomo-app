<template>
  <header data-role="Header" class="header-header" v-bind:class="rootClassName">
    <span class="header-text">
      <span>Men&apos;</span>
      <span class="header-text2">s sh</span>
      <span>op</span>
    </span>
    ...
    <div data-role="MobileMenu" class="header-mobile-menu">
      ...
      <div>
        <svg viewBox="0 0 950.8571428571428 1024" class="header-icon02">
          <path
          ...
          ></path></svg
        ><svg viewBox="0 0 877.7142857142857 1024" class="header-icon04">
          <path
          ...
          ></path></svg
        ><svg viewBox="0 0 602.2582857142856 1024" class="header-icon06">
          <path
    ...
    <svg @click="router.push('/menu')" 
     viewBox="0 0 1024 1024" class="header-icon08">
      <path
